...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Namecoin");
    QApplication::setOrganizationDomain("namecoin.info");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Namecoin-Qt-testnet");
    else
        QApplication::setApplicationName("Namecoin-Qt");
    ...
    try
    {
        ...
        if(AppInit2(threadGroup))
        {
            ...
            // Shutdown the core and its threads, but don't exit Namecoin-Qt here
