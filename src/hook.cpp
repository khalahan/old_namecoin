...
public:
    ...
    /*virtual bool ConnectInputs(CTxDB& txdb,
            ...
            bool fBlock,
            bool fMiner);*/
    virtual bool CheckInputs(CValidationState &state, CCoinsViewCache &inputs, bool fScriptChecks, unsigned int flags, std::vector<CScriptCheck> *pvChecks);
    ...
    void AcceptToMemoryPool(CValidationState &state, bool fCheckInputs, bool fLimitFree, bool* pfMissingInputs)
    {
    }
...
bool CStandardHooks::ConnectBlock(CValidationState &state, CBlockIndex *pindex, CCoinsViewCache &coins, bool fJustCheck)
{
    return true;
}

//bool CStandardHooks::DisconnectBlock(CBlock& block, CTxDB& txdb, CBlockIndex* pindex)
bool CStandardHooks::DisconnectBlock(CValidationState &state, CBlockIndex *pindex, CCoinsViewCache &coins, bool *pfClean)
{
    return true;
}
